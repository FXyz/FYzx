...
import physics.constraints.SpringLink;
...
public class Particle extends Body<Sphere> {
    ...
    public Particle(double radius, double mass, Point3D position, boolean forceAffected) {
        ...
        this.setIntegrator(new RK4Integrator(getState()));
    ...
    /*==========================================================================
     Link Attachments
     */
    public void attachTo(Body P, double restingDist, double stiff) {

        SpringLink lnk = new SpringLink(getState(), P.getState(), restingDist, stiff);
        addConstraint(lnk);
    }
    /*
     Delegate Methods

...
import cloth.mesh.demo.ClothMesh;
import physics.constraints.PointLink;
...
public final class WeightedPoint {
    ...
    private static final Logger log = Logger.getLogger(WeightedPoint.class.getName());
    ...
    private final int defaultSolvingLevels = 4;
    private int solvingLevels = -1;
     ...
     */
    public int getSolvingLevels() {
        return solvingLevels != -1 ? solvingLevels : defaultSolvingLevels;
    }

    public void setSolvingLevels(int solvingLevels) {
        this.solvingLevels = solvingLevels;
    }
    /*==========================================================================
